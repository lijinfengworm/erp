...
*/
(function(win) {
	var root = win.GV.JS_ROOT || location.origin + '/statics/js/', //在wind.js加载之前定义GV.JS_ROOT
		ver = '',
		//定义常用JS组件别名，使用别名加载
		alias = {
            jquery             : 'jquery',
            artDialog         : 'lib/artDialog/dialog-min',
            artDialogPlus         : 'lib/artDialog/dialog-plus',
            ...
            tips         : 'lib/tips/simpletooltip',
            limitTxt         : 'lib/limittext',
		},
		
		
        //CSS路径
		alias_css = {
            artDialog   : 'lib/artDialog/ui-dialog',
            chosen         : 'lib/chosen/chosen',
            colorPicker         : 'lib/colorPicker/style',
            treeTable         : 'lib/treetable/css/treetable',
            tips         : 'lib/tips/simpletooltip',
		};
