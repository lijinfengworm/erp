(function (root, factory) {
    ...
    var cssText = " .ui-alert-mask { position: fixed; top: 0; right: 0; bottom: 0; left: 0; z-index: 1000; width: 100%; height: 100%; background-color: rgba(4, 0, 0, 0.5);  } \
                    ...
                    .ui-alert-mask .ui-alert .ui-alert-hd h2 { line-height: 1.5; margin: 0; padding: 10px 0; font-size: 15px; font-weight: normal;} \
                    ...
                    .ui-btn { display:block;width: 45%; padding: 6px 0; font-size: 14px; border-radius: 4px; text-decoration: none;} \
    ...
    var domText = '<div class="ui-alert-mask"> \
                        <div class="ui-alert"> \
                            ...
                            <div class="ui-alert-bd"> \
                                <a href="javascript:void(0)" class="ui-btn ui-btn-cancel" id="js-alert-cancel">取消</a> \
