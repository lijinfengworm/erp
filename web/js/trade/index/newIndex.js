$(function(){
    ...
    $(".content-area-min3").find(".list span").click(function(){
         var eq = $(this).index();
         $(this).siblings().removeClass('on');
         $(this).addClass('on');
         $(this).parents(".content-area-min3").find(".goods-list").hide();
         $(this).parents(".content-area-min3").find(".goods-list").eq(eq).show();
    });
});
