...
function addImage(src) {
  ...
  newImgDiv.innerHTML = '<img src="'+src+'?imageView/1/w/100/h/100" data_src="'+src+'" class="get_img_src" />';
  newImgDiv.innerHTML += '<p class="close-img"><input type="hidden" name="pictures" value="'+(src.substring(src.lastIndexOf('path=')+5)).replace(/_/g,'/')+'" /><a href="javascript:delPic('+(thumbid+1)+');">&nbsp;</a></p>';
