...
class Tree {
    ...
    public function setPrintid($printid = 'printid') {
    ...
    public function get_parent($myid) {
        ...
        if (!isset($this->arr[$myid]))
            return false;
        $pid = $this->arr[$myid][$this->printid];
        $pid = $this->arr[$pid][$this->printid];
        if (is_array($this->arr)) {
            foreach ($this->arr as $id => $a) {
                if ($a[$this->printid] == $pid)
                    $newarr[$id] = $a;
            }
        }
        return $newarr;
    ...
    public function get_child($myid) {
        ...
        if (is_array($this->arr)) {
            foreach ($this->arr as $id => $val) {
                if(isset($val[$this->printid])) {
                    if ($val[$this->printid] == $myid)
                        $newarr[$id] = $val;
                }
            }
        }
