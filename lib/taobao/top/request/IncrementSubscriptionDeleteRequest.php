<?php
/**
 * TOP API: taobao.increment.subscription.delete request
 * 
 * @author auto create
 * @since 1.0, 2012-12-19 11:36:47
 */
class IncrementSubscriptionDeleteRequest
{
	/** 
	...
	/** 
	 * 订阅的消息属性值。和subscribe_key确定消息的订阅。用‘，’分隔的多个属性值; 最多传入20个。
当传入的属性值未订阅时，会跳过此值订阅的删除。
	 **/
