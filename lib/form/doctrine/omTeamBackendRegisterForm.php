 ...
 */
 class omTeamBackendRegisterForm extends omTeamRegisterAdminForm
{
  public function configure()
  {
     $choiceData = Doctrine_Core::getTable('Location')->getSelectData();
     $ipPlaceId = omTeamTable::getPlaceIdByIp();
    ...
    $this->setValidators(array(
       'name'             => new sfValidatorAnd(array(
	    						new  myValidatorString(
	    							...
	    							array('min_length'=>'球队名长度为4-14个字符','max_length'=>'球队名长度为4-14个字符')),
	    						new  sfValidatorRegex(
	    							array('pattern'=>'/^([0-9a-zA-Z一-龥]+)$/u'),
	    							array('invalid'=>'球队名仅允许中英文和数字'))
	    						),
	    						array('required'=>true),
      ...
      'leaderName'        => new sfValidatorAnd(array(
	    						new  myValidatorString(
	    							...
	    							array('min_length'=>'领队名称长度为3-14个字符','max_length'=>'领队名称长度为3-14个字符')),
	    						new  sfValidatorRegex(
	    							array('pattern'=>'/^([a-zA-Z一-龥]+)$/u'),
	    							array('invalid'=>'领队名仅允许中英文'))
	    						),
	    						array('required'=>true),
