...
/**
 * TrdMarketingActivityGroup form base class.
 *
 * @method TrdMarketingActivityGroup getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseTrdMarketingActivityGroupForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('trd_marketing_activity_group[%s]');
  ...
  {
    return 'TrdMarketingActivityGroup';
  }
