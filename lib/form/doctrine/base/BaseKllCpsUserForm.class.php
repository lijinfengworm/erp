...
/**
 * KllCpsUser form base class.
 *
 * @method KllCpsUser getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseKllCpsUserForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'KllCpsUser', 'column' => array('union_id')))
    );

    $this->widgetSchema->setNameFormat('kll_cps_user[%s]');
