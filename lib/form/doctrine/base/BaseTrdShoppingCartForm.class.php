...
/**
 * TrdShoppingCart form base class.
 *
 * @method TrdShoppingCart getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseTrdShoppingCartForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('trd_shopping_cart[%s]');
