...
/**
 * KllOpenimInfo form base class.
 *
 * @method KllOpenimInfo getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseKllOpenimInfoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kll_openim_info[%s]');
