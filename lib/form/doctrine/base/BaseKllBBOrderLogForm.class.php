...
/**
 * KllBBOrderLog form base class.
 *
 * @method KllBBOrderLog getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseKllBBOrderLogForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'operation_user' => new sfWidgetFormInputText(),
    ));
    ...
    $this->widgetSchema->setNameFormat('kll_bb_order_log[%s]');
