...
/**
 * TrdMessage form base class.
 *
 * @method TrdMessage getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseTrdMessageForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('trd_message[%s]');
