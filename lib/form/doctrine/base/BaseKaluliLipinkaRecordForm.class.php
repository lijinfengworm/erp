...
/**
 * KaluliLipinkaRecord form base class.
 *
 * @method KaluliLipinkaRecord getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseKaluliLipinkaRecordForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kaluli_lipinka_record[%s]');
