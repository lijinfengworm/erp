...
/**
 * TrdLipinkaLarge form base class.
 *
 * @method TrdLipinkaLarge getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseTrdLipinkaLargeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('trd_lipinka_large[%s]');
