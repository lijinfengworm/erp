...
/**
 * KllBBOrderFlow form base class.
 *
 * @method KllBBOrderFlow getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseKllBBOrderFlowForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kll_bb_order_flow[%s]');
