...
/**
 * TrdHomepageItem form base class.
 *
 * @method TrdHomepageItem getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseTrdHomepageItemForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('trd_homepage_item[%s]');
