...
/**
 * KllMainOrder form base class.
 *
 * @method KllMainOrder getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseKllMainOrderForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kll_main_order[%s]');
