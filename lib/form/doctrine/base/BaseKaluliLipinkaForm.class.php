...
/**
 * KaluliLipinka form base class.
 *
 * @method KaluliLipinka getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseKaluliLipinkaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kaluli_lipinka[%s]');
