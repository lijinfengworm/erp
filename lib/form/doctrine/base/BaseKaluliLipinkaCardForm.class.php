...
/**
 * KaluliLipinkaCard form base class.
 *
 * @method KaluliLipinkaCard getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseKaluliLipinkaCardForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kaluli_lipinka_card[%s]');
