...
/**
 * KllBBMainOrderAttr form base class.
 *
 * @method KllBBMainOrderAttr getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseKllBBMainOrderAttrForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kll_bb_main_order_attr[%s]');
