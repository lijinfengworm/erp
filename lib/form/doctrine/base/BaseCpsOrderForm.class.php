...
/**
 * CpsOrder form base class.
 *
 * @method CpsOrder getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseCpsOrderForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cps_order[%s]');
