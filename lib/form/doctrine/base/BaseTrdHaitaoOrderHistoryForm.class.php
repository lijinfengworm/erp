...
/**
 * TrdHaitaoOrderHistory form base class.
 *
 * @method TrdHaitaoOrderHistory getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseTrdHaitaoOrderHistoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('trd_haitao_order_history[%s]');
