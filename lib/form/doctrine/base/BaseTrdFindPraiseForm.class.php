...
/**
 * TrdFindPraise form base class.
 *
 * @method TrdFindPraise getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseTrdFindPraiseForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('trd_find_praise[%s]');
