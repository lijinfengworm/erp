...
/**
 * KllOrderFile form base class.
 *
 * @method KllOrderFile getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseKllOrderFileForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kll_order_file[%s]');
