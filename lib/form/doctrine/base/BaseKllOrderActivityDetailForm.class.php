...
/**
 * KllOrderActivityDetail form base class.
 *
 * @method KllOrderActivityDetail getObject() Returns the current form's model object
 *
 * @package    HC
 * @subpackage form
 ...
 */
abstract class BaseKllOrderActivityDetailForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kll_order_activity_detail[%s]');
