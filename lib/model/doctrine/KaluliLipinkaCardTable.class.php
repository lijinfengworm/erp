...
/**
 * KaluliLipinkaCardTable
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 */
class KaluliLipinkaCardTable extends Doctrine_Table
{
    ...
    //卡密正则规则
    public static $cardRegex = '/^[\s\S]*?$/';
    //大卡密
    public static $cardLargeRegex = '/^[\s\S]*?$/';
    ...
    {
        return Doctrine_Core::getTable('KaluliLipinkaCard');
    }
