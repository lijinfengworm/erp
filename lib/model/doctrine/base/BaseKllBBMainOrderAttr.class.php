...
Doctrine_Manager::getInstance()->bindComponent('KllBBMainOrderAttr', 'kaluliBB');

/**
 * BaseKllBBMainOrderAttr
 * 
 ...
 * @method KllBBMainOrderAttr setId()              Sets the current record's "id" value
 * @method KllBBMainOrderAttr setOrderNumber()     Sets the current record's "order_number" value
 * @method KllBBMainOrderAttr setProvince()        Sets the current record's "province" value
 * @method KllBBMainOrderAttr setCity()            Sets the current record's "city" value
 * @method KllBBMainOrderAttr setArea()            Sets the current record's "area" value
 * @method KllBBMainOrderAttr setAddress()         Sets the current record's "address" value
 * @method KllBBMainOrderAttr setRealName()        Sets the current record's "real_name" value
 * @method KllBBMainOrderAttr setAccount()         Sets the current record's "account" value
 * @method KllBBMainOrderAttr setReceiver()        Sets the current record's "receiver" value
 * @method KllBBMainOrderAttr setMobile()          Sets the current record's "mobile" value
 * @method KllBBMainOrderAttr setLogisticNumber()  Sets the current record's "logistic_number" value
 * @method KllBBMainOrderAttr setPostalCode()      Sets the current record's "postal_code" value
 * @method KllBBMainOrderAttr setCardType()        Sets the current record's "card_type" value
 * @method KllBBMainOrderAttr setCardCode()        Sets the current record's "card_code" value
 * @method KllBBMainOrderAttr setCreatTime()       Sets the current record's "creat_time" value
 * @method KllBBMainOrderAttr setUpdateTime()      Sets the current record's "update_time" value
 * 
 * @package    HC
 * @subpackage model
 ...
 */
abstract class BaseKllBBMainOrderAttr extends sfDoctrineMasterSlaveRecord
{
