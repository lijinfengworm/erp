...
Doctrine_Manager::getInstance()->bindComponent('TrdDaigouTags', 'trade');
 ...
 * @method TrdDaigouTags setId()          Sets the current record's "id" value
 * @method TrdDaigouTags setRootId()      Sets the current record's "root_id" value
 * @method TrdDaigouTags setChildrenId()  Sets the current record's "children_id" value
 * @method TrdDaigouTags setTagsAttr()    Sets the current record's "tags_attr" value
 * @method TrdDaigouTags setStatus()      Sets the current record's "status" value
 * @method TrdDaigouTags setCreatedAt()   Sets the current record's "created_at" value
 * @method TrdDaigouTags setUpdatedAt()   Sets the current record's "updated_at" value
 * 
 * @package    HC
 * @subpackage model
 ...
 */
abstract class BaseTrdDaigouTags extends sfDoctrineMasterSlaveRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('trd_daigou_tags');
