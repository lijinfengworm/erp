...
Doctrine_Manager::getInstance()->bindComponent('KllMainOrder', 'kaluliBB');
 ...
 * @method KllMainOrder setId()                  Sets the current record's "id" value
 * @method KllMainOrder setOrderNumber()         Sets the current record's "order_number" value
 * @method KllMainOrder setOriginOrderNumber()   Sets the current record's "origin_order_number" value
 * @method KllMainOrder setTotalPrice()          Sets the current record's "total_price" value
 * @method KllMainOrder setPushPrice()           Sets the current record's "push_price" value
 * @method KllMainOrder setRealPrice()           Sets the current record's "real_price" value
 * @method KllMainOrder setExpressFee()          Sets the current record's "express_fee" value
 * @method KllMainOrder setDutyFee()             Sets the current record's "duty_fee" value
 * @method KllMainOrder setCouponFee()           Sets the current record's "coupon_fee" value
 * @method KllMainOrder setPayStatus()           Sets the current record's "pay_status" value
 * @method KllMainOrder setPayType()             Sets the current record's "pay_type" value
 * @method KllMainOrder setPayTime()             Sets the current record's "pay_time" value
 * @method KllMainOrder setUid()                 Sets the current record's "uid" value
 * @method KllMainOrder setStatus()              Sets the current record's "status" value
 * @method KllMainOrder setLogisticType()        Sets the current record's "logistic_type" value
 * @method KllMainOrder setLogisticNumber()      Sets the current record's "logistic_number" value
 * @method KllMainOrder setFlowNumber()          Sets the current record's "flow_number" value
 * @method KllMainOrder setPayer()               Sets the current record's "payer" value
 * @method KllMainOrder setSource()              Sets the current record's "source" value
 * @method KllMainOrder setCount()               Sets the current record's "count" value
 * @method KllMainOrder setAuditTime()           Sets the current record's "audit_time" value
 * @method KllMainOrder setCreatTime()           Sets the current record's "creat_time" value
 * @method KllMainOrder setUpdateTime()          Sets the current record's "update_time" value
 * 
 * @package    HC
 * @subpackage model
 ...
 */
abstract class BaseKllMainOrder extends sfDoctrineMasterSlaveRecord
{
