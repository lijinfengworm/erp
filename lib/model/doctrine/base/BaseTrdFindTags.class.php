...
Doctrine_Manager::getInstance()->bindComponent('TrdFindTags', 'trade');
 ...
 * @method TrdFindTags setId()          Sets the current record's "id" value
 * @method TrdFindTags setRootId()      Sets the current record's "root_id" value
 * @method TrdFindTags setChildrenId()  Sets the current record's "children_id" value
 * @method TrdFindTags setTagsAttr()    Sets the current record's "tags_attr" value
 * @method TrdFindTags setStatus()      Sets the current record's "status" value
 * @method TrdFindTags setCreatedAt()   Sets the current record's "created_at" value
 * @method TrdFindTags setUpdatedAt()   Sets the current record's "updated_at" value
 * 
 * @package    HC
 * @subpackage model
 ...
 */
abstract class BaseTrdFindTags extends sfDoctrineMasterSlaveRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('trd_find_tags');
