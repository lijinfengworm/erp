...
Doctrine_Manager::getInstance()->bindComponent('TrdLipinka', 'trade');
 ...
 * @method TrdLipinka setId()             Sets the current record's "id" value
 * @method TrdLipinka setTitle()          Sets the current record's "title" value
 * @method TrdLipinka setApplyUserId()    Sets the current record's "apply_user_id" value
 * @method TrdLipinka setType()           Sets the current record's "type" value
 * @method TrdLipinka setActivityType()   Sets the current record's "activity_type" value
 * @method TrdLipinka setForWhat()        Sets the current record's "for_what" value
 * @method TrdLipinka setVerifyUserId()   Sets the current record's "verify_user_id" value
 * @method TrdLipinka setStime()          Sets the current record's "stime" value
 * @method TrdLipinka setEtime()          Sets the current record's "etime" value
 * @method TrdLipinka setAmount()         Sets the current record's "amount" value
 * @method TrdLipinka setStatus()         Sets the current record's "status" value
 * @method TrdLipinka setIsDelete()       Sets the current record's "is_delete" value
 * 
 * @package    HC
 * @subpackage model
 ...
 */
abstract class BaseTrdLipinka extends sfDoctrineMasterSlaveRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('trd_lipinka');
