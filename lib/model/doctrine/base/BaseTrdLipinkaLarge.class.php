...
Doctrine_Manager::getInstance()->bindComponent('TrdLipinkaLarge', 'trade');
 ...
 * @method TrdLipinkaLarge setId()            Sets the current record's "id" value
 * @method TrdLipinkaLarge setLipinkaId()     Sets the current record's "lipinka_id" value
 * @method TrdLipinkaLarge setRecordId()      Sets the current record's "record_id" value
 * @method TrdLipinkaLarge setCard()          Sets the current record's "card" value
 * @method TrdLipinkaLarge setNum()           Sets the current record's "num" value
 * @method TrdLipinkaLarge setNoReceive()     Sets the current record's "no_receive" value
 * @method TrdLipinkaLarge setPostponeType()  Sets the current record's "postpone_type" value
 * @method TrdLipinkaLarge setPostponeDay()   Sets the current record's "postpone_day" value
 * @method TrdLipinkaLarge setOverdueTime()   Sets the current record's "overdue_time" value
 * @method TrdLipinkaLarge setStime()         Sets the current record's "stime" value
 * @method TrdLipinkaLarge setEtime()         Sets the current record's "etime" value
 * @method TrdLipinkaLarge setStatus()        Sets the current record's "status" value
 * 
 * @package    HC
 * @subpackage model
 ...
 */
abstract class BaseTrdLipinkaLarge extends sfDoctrineMasterSlaveRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('trd_lipinka_large');
