 ...
 */
class KllKolOrderTable extends Doctrine_Table
{
    /**
     * Returns an instance of this class.
     *
     * @return object KllKolOrderTable
     */
    public static function getInstance()
    {
        return Doctrine_Core::getTable('KllKolOrder');
    }
    ...
    public static function getAll($bind = array())
    {
        ...
        if(!empty($bind['having'])) {
            $data->addHaving($bind['having']);
        }
