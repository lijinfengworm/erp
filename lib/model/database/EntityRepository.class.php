...
{   
  public function __construct($connectionName = 'hupuMemcache')
  {
    $this->connection = sfContext::getInstance()->getDatabaseConnection($connectionName);
  }
  ...
  public function persist($object)
  {
    ...
    public static function setChannelVideoAndImg($category_id) {
        ...
        if($category_id == 11){
            $url = 'http://photo.liangle.com/index.php' . '?controller=api&action=getalbumbymutitag&num=2&tag=' . iconv('utf-8', 'gbk', sfConfig::get('app_category_11'));
        }else{
            $url = 'http://photo.liangle.com/index.php' . '?controller=api&action=getalbumbytag&num=2&tag=' . iconv('utf-8', 'gbk', sfConfig::get('app_category_'.$category_id));
        }
...
//        var_dump($data['images']);
    ...
    public static function setBeauty() {
        ...
        $url = 'http://photo.liangle.com/index.php' . '?controller=api&action=getalbumbytag&num=4&tag=' . iconv('utf-8', 'gbk', '美女');
