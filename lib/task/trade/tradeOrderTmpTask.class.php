...
class tradeOrderTmpTask extends sfBaseTask
{
...
The [trade:OrderTmp|INFO] task does things.
Call it with:

  [php symfony trade:OrderTmp|INFO]
EOF;
  }
  ...
  protected function execute($arguments = array(), $options = array()){
      ...
      // initialize the database connection
        ...
        for($i=20000;$i<=23000;$i++){
            $oldObj = TrdHaitaoOrderTable::getInstance()->find($i);
