...
class voiceVocie_error404_pageTask extends sfBaseTask
{
  protected function configure()
  {
    ...
    $this->name             = 'voice_error404_page';
    $this->briefDescription = '生成404错误静态页';
    $this->detailedDescription = <<<EOF
The [voice:vocie_error404_page|INFO] task does things.
Call it with:

  [php symfony voice:vocie_error404_page|INFO]
EOF;
  }
  ...
  protected function execute($arguments = array(), $options = array())
  {
      ...
      $pageinfo = @file_get_contents('http://voice.hupu.com/error/404');
      ...
      if (!$pageinfo || strpos($page, '服务器出错了') !== false){
          ...
          if (file_exists($pagedir . '/voice_error404.html')){
              $status = copy($pagedir . '/voice_error404.html', $pagedir . '/voice_error404.backup.html');
        ...
        if (file_put_contents($pagedir . '/voice_error404.html', $pageinfo)){
