...
abstract class sfController
{
  ...
  public function forward($moduleName, $actionName)
  {
    ...
    if (!$this->actionExists($moduleName, $actionName))
    {
      ...
      throw new sfError404Exception(sprintf('Action "%s/%s" does not exist. request_uri:%s , referer:%s', $moduleName, $actionName,$_SERVER["HTTP_HOST"].$_SERVER['REQUEST_URI'],$_SERVER['HTTP_REFERER']));
    }
