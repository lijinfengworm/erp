...
/**
 * TrdActivity filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseTrdActivityFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'exchange_type'  => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'exchange_type'  => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('trd_activity_filters[%s]');
