...
/**
 * TrdUserCollections filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseTrdUserCollectionsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('trd_user_collections_filters[%s]');
