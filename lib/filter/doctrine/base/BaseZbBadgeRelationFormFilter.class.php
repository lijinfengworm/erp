...
/**
 * ZbBadgeRelation filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseZbBadgeRelationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'badge_id'   => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('ZbBadges'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'badge_id'   => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('ZbBadges'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('zb_badge_relation_filters[%s]');
