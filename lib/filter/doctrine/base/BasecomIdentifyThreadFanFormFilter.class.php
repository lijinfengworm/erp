...
/**
 * comIdentifyThreadFan filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BasecomIdentifyThreadFanFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('com_identify_thread_fan_filters[%s]');
