...
/**
 * KllArticlePool filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseKllArticlePoolFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kll_article_pool_filters[%s]');
