...
/**
 * KaluliMainOrderAttr filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseKaluliMainOrderAttrFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_remind'          => new sfWidgetFormFilterInput(),
      'remark'             => new sfWidgetFormFilterInput(),
      'coupon_id'          => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'is_remind'          => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'remark'             => new sfValidatorPass(array('required' => false)),
      'coupon_id'          => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'created_at'         => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 00:00:00')), 'to_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 23:59:59')))),
      'updated_at'         => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 00:00:00')), 'to_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 23:59:59')))),
    ));

    $this->widgetSchema->setNameFormat('kaluli_main_order_attr_filters[%s]');
