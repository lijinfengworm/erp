...
/**
 * TrdModel filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseTrdModelFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('trd_model_filters[%s]');
