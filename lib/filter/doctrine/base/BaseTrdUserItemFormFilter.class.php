...
/**
 * TrdUserItem filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseTrdUserItemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'item_all_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('ItemAll'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('trd_user_item_filters[%s]');
