...
/**
 * TrdDaigouContentTpl filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseTrdDaigouContentTplFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('trd_daigou_content_tpl_filters[%s]');
