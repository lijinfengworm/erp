...
/**
 * trdCommentPraise filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BasetrdCommentPraiseFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('trd_comment_praise_filters[%s]');
