...
/**
 * kllActivityTradeLog filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BasekllActivityTradeLogFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kll_activity_trade_log_filters[%s]');
