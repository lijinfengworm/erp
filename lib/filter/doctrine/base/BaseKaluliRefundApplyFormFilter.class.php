...
/**
 * KaluliRefundApply filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseKaluliRefundApplyFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'check_remark'   => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'check_remark'   => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('kaluli_refund_apply_filters[%s]');
