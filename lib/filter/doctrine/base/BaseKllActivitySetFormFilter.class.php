...
/**
 * KllActivitySet filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseKllActivitySetFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kll_activity_set_filters[%s]');
