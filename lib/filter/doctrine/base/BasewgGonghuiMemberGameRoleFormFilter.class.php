...
/**
 * wgGonghuiMemberGameRole filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BasewgGonghuiMemberGameRoleFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'wggonghuigroup_id'  => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      'wggonghuigroup_id'  => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('wg_gonghui_member_game_role_filters[%s]');
  ...
  {
    return 'wgGonghuiMemberGameRole';
  }
