...
/**
 * KllOrderFile filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseKllOrderFileFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kll_order_file_filters[%s]');
