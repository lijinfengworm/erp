...
/**
 * ErObject filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseErObjectFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('er_object_filters[%s]');
