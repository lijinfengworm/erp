...
/**
 * ZyAvatar filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseZyAvatarFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('zy_avatar_filters[%s]');
