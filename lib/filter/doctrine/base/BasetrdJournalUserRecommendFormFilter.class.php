...
/**
 * trdJournalUserRecommend filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BasetrdJournalUserRecommendFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('trd_journal_user_recommend_filters[%s]');
