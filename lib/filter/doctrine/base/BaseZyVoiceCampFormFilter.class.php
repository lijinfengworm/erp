...
/**
 * ZyVoiceCamp filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseZyVoiceCampFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('zy_voice_camp_filters[%s]');
