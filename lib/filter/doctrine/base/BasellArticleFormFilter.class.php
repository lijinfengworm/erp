...
/**
 * llArticle filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BasellArticleFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'll_tags_list'                 => new sfWidgetFormDoctrineChoice(array('multiple' => true, 'model' => 'llTag')),
    ));
    ...
    $this->setValidators(array(
      ...
      'll_tags_list'                 => new sfValidatorDoctrineChoice(array('multiple' => true, 'model' => 'llTag', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('ll_article_filters[%s]');
  ...
  public function addLlTagsListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    if (!is_array($values))
    {
      $values = array($values);
    ...
    $query
      ...
      ->andWhereIn('llArticleTag.ll_tag_id', $values)
    ;
  }
