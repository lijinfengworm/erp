...
/**
 * touchScreenTextChain filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BasetouchScreenTextChainFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'news_text'  => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'news_url'   => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->widgetSchema->setNameFormat('touch_screen_text_chain_filters[%s]');
