...
/**
 * kllLipinkaLog filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BasekllLipinkaLogFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kll_lipinka_log_filters[%s]');
