...
/**
 * KllOrderFlow filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseKllOrderFlowFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kll_order_flow_filters[%s]');
