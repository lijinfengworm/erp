...
/**
 * CpsOrder filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseCpsOrderFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cps_order_filters[%s]');
