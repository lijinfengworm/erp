...
/**
 * wpPayOrder filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BasewpPayOrderFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('wp_pay_order_filters[%s]');
