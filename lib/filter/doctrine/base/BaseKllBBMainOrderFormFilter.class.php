...
/**
 * KllBBMainOrder filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseKllBBMainOrderFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'syn_api'             => new sfWidgetFormFilterInput(),
    ...
    $this->widgetSchema->setNameFormat('kll_bb_main_order_filters[%s]');
