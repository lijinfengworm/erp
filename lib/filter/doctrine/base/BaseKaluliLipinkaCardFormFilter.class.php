...
/**
 * KaluliLipinkaCard filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseKaluliLipinkaCardFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kaluli_lipinka_card_filters[%s]');
