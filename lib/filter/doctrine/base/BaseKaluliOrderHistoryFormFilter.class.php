...
/**
 * KaluliOrderHistory filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseKaluliOrderHistoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kaluli_order_history_filters[%s]');
