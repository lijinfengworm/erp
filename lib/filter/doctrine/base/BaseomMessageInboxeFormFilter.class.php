...
/**
 * omMessageInboxe filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseomMessageInboxeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('om_message_inboxe_filters[%s]');
