...
/**
 * ZyObjectNew filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseZyObjectNewFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('zy_object_new_filters[%s]');
