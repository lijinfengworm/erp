...
/**
 * KaluliLipinkaRecord filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseKaluliLipinkaRecordFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'card_limit'    => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->widgetSchema->setNameFormat('kaluli_lipinka_record_filters[%s]');
