...
/**
 * KllBBOrder filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseKllBBOrderFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ware_status'        => new sfWidgetFormFilterInput(),
      'status'             => new sfWidgetFormFilterInput(),
      'ware_house'         => new sfWidgetFormFilterInput(),
    ));
    ...
    $this->widgetSchema->setNameFormat('kll_bb_order_filters[%s]');
