...
/**
 * KllBBMainOrderAttr filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseKllBBMainOrderAttrFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kll_bb_main_order_attr_filters[%s]');
