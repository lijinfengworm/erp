...
/**
 * KllCategory filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseKllCategoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kll_category_filters[%s]');
