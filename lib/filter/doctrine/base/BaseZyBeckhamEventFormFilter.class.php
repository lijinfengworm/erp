...
/**
 * ZyBeckhamEvent filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseZyBeckhamEventFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('zy_beckham_event_filters[%s]');
