...
/**
 * TrdMarketingActivityGroup filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseTrdMarketingActivityGroupFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('trd_marketing_activity_group_filters[%s]');
