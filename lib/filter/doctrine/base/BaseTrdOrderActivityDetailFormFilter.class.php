...
/**
 * TrdOrderActivityDetail filter form base class.
 *
 * @package    HC
 * @subpackage filter
 ...
 */
abstract class BaseTrdOrderActivityDetailFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('trd_order_activity_detail_filters[%s]');
