<?php
/**
 * API: qianmi.cloudshop.logistics.address.update request
 * 
 * @author auto create
 * @since 1.0
 */
class LogisticsAddressUpdateRequest
{
	...
	/** 
	 * 是否默认退货地址，只有admin卖家有该字段，1-是，选择此项(1)，将当前地址设为默认地址，撤消原默货地址
	 */
	private $cancelDef;
	...
	/** 
	 * 是否是收货地址 1-是，选择此项(1)，将当前地址设为默认地址，撤消原默货地址
	 */
	private $deliveryDef;

	/** 
	 * 卖家：表示是否默认提货地址，买家：是否默认收货地址，1-是，选择此项(1)，将当前地址设为默认地址，撤消原默货地址
	 */
	private $getDef;
	...
	/** 
	 * 是否默认发货地址，只有admin卖家有该字段，1-是，选择此项(1)，将当前地址设为默认地址，撤消原默货地址
	 */
	private $sendDef;
	...
	{
		return "qianmi.cloudshop.logistics.address.update";
	}
