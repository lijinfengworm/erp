...
*/
	include_once("KllSDKRuntimeException.php");
	include_once("KllWxPay.pub.config.php");
...
* JSAPI支付——H5网页端调起支付接口
*/
class Kll_JsApi_pub extends Common_util_pub
{
...
//		curl_setopt($ch, CURLOP_TIMEOUT, $this->curl_timeout);
	...
	public function getParameters()
	{
		...
		kaluliLog::info("weiixnParam",array("param"=>$this->parameters));
