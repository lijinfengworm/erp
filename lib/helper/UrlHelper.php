...
function cross_app_url_for($appname, $url, $absolute = false, $env = null, $debug = false)
{
  ...
  {
//      $configuration = ProjectConfiguration::getApplicationConfiguration('ommatch', 'dev', true);var_dump($configuration);exit;
//sfContext::createInstance($configuration)->dispatch();
//      var_dump(ProjectConfiguration::getApplicationConfiguration($appname, $env, true));
    $context = sfContext::createInstance(ProjectConfiguration::getApplicationConfiguration($appname, $env, true), $appname);
  }
  else
  {
